...
struct aml_input_function {
	int (*input_open)(void **handle, aml_stream_config_t * stream_config, audio_devices_t out_device);	
...
int aml_input_open(struct audio_stream_in *stream, aml_stream_config_t * stream_config, audio_devices_t out_device);
